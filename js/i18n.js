...
(function () {
  const STR = {
    en: {
      ...
      portfolio: "Portfolio", add_transaction: "Add a transaction", symbol: "Symbol",
      buy: "Buy", sell: "Sell", shares: "Shares", price_aed: "Price (AED)", add: "Add",
      pf_note: "Enter each buy and sell with its date and price. Stored only on this device. Dividends are matched from the stock's distribution history by ex-date.",
      no_portfolio: "No transactions yet — add a buy above to start tracking returns.",
      invested: "Invested", current_value: "Current value", total_return: "Total return",
      price_return: "Price", div_return: "Dividend", dividends_received: "Dividends received",
      positions: "Positions", clear_portfolio: "Clear portfolio", remove: "Remove",
      clear_confirm: "Clear the entire portfolio? This cannot be undone.",
      pf_disclaimer: "Your private ledger (this device only). Returns use delayed prices and recorded dividends — informational, not advice or a brokerage statement.",
    ...
    ar: {
      ...
      portfolio: "محفظتي", add_transaction: "إضافة عملية", symbol: "الرمز",
      buy: "شراء", sell: "بيع", shares: "الأسهم", price_aed: "السعر (درهم)", add: "إضافة",
      pf_note: "أدخل كل عملية شراء وبيع بتاريخها وسعرها. تُحفظ على هذا الجهاز فقط. تُحتسب التوزيعات من سجل توزيعات السهم حسب تاريخ الاستحقاق.",
      no_portfolio: "لا توجد عمليات بعد — أضف عملية شراء أعلاه لتتبّع العوائد.",
      invested: "المستثمَر", current_value: "القيمة الحالية", total_return: "إجمالي العائد",
      price_return: "السعر", div_return: "التوزيعات", dividends_received: "التوزيعات المستلمة",
      positions: "المراكز", clear_portfolio: "مسح المحفظة", remove: "حذف",
      clear_confirm: "مسح المحفظة بالكامل؟ لا يمكن التراجع.",
      pf_disclaimer: "سجلّك الخاص (على هذا الجهاز فقط). العوائد تستخدم أسعاراً مؤجّلة وتوزيعات مسجّلة — للمعلومة فقط، وليست نصيحة أو كشف حساب وساطة.",
